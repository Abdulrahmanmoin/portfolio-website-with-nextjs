...
const HomeComp = () => {
  return (
    <section id='home' className='mb-5 lg:mb-14 min-h-[90vh]'>


      <div className='sm:flex sm:gap-x-[6rem] md:gap-x-[14rem] lg:gap-x-[26rem] xl:gap-x-[40rem]'>
        {/* div for the both boxes */}
        <div className='intro-both-boxes flex flex-col items-center justify-center -ml-7 sm:items-start sm:mt-8 sm:ml-28 lg:mt-1 lg:ml-28 pb-20 sm:pb-0'>
          ...
          <AOSWrapper >
            <div data-aos="fade-right" data-aos-duration="700" className='intro-box intro-laptop-box max-w-72 shadow-xl self-start rounded-xl flex gap-10 sm:gap-14 flex-row-reverse items-center bg-white px-4 py-3  sm:px-4 sm:py-3 md:px-5 md:py-4 mt-9 sm:mt-6 lg:mt-8'>
              ...
              <div>
                <h2 className='intro-box-profession-heading text-gray-500 text-xs uppercase font-semibold '>Full Stack Developer</h2>
              </div>
            </div>
          </AOSWrapper>
        </div>
      ...
      <div>
        <SocialIcons className='hidden sm:block absolute mt-64 sm:mt-28 md:mt-40 lg:mt-52 xl:mt-60' />
      </div>
      ...
      <AOSWrapper >
        <div className='tech-stacks-container  ml-12 sm:ml-0'>
