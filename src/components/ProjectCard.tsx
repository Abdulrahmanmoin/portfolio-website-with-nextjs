...
const ProjectCard: FC<objType> = ({ objFromArr }) => {
    return (
        ...
        >
            ...
            <div className='w-52 py-5 flex justify-around'>

                <div className='bg-black bg-opacity-40 rounded-full p-2'>
                    <Link href={objFromArr.githubLink} target='_blank'><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
                ...
                0-247.2-200.4-447.3-447.5-447.3z"></path></svg></Link>
                </div>
